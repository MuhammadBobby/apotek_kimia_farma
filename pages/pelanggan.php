...
<body class="g-sidenav-show bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg">
    ...
    <div class="container-fluid py-4">
      <div class="mb-5">
        <a href="functions/tambahpelanggan.php" class="p-3 rounded-2 bg-gradient-success text-bold">Tambah Data Pelanggan</a>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6 class="text-2xl text-bold">Tabel Pelanggan</h6>
            </div>
                  ...
                  <tbody>
                    ...
                    <?php while ($apt = $hasil->fetch_assoc()) : ?>
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm text-warning"><?= $apt['id_pelanggan'] ?></td>
                        <td class="text-md mb-0"><?= $apt['nama_pelanggan'] ?></td>
                        <td class="align-middle text-center text-sm"><?= $apt['alamat'] ?></td>
                        <td class="align-middle text-center text-sm"><?php if ($apt["jenis_kelamin"] == "lk") {
                                                                        echo "Laki-Laki";
                                                                      } else if ($apt["jenis_kelamin"] == "pr") {
                                                                        echo "Perempuan";
                                                                      }
                                                                      ?></td>
                        <td class="align-middle text-center text-sm"><?= $apt['pekerjaan'] ?></td>
                        <td class="align-middle text-center text-sm"><?= $apt['usia'] ?> Tahun</td>
                        <td class="align-middle">
                          <a href="functions/editpelanggan.php?id=<?= $apt['id_pelanggan'] ?>"><i class="material-icons">edit</i></a>
                          <a href="functions/hapuspelanggan.php?id=<?= $apt['id_pelanggan'] ?>"><i class="material-icons" onclick=" return confirm ('Apakah Anda Yakin Ingin Menghapus data Ini ?');">delete</i></a>
                        </td>
                      </tr>
                      <?php $i++ ?>
                    <?php endwhile; ?>

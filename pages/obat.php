...
// read
$query = "SELECT * FROM obat, supplier WHERE obat.id_supplier = supplier.id_supplier";
...
<body class="g-sidenav-show bg-gray-100">
    ...
    <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../pages/obat.php">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <main class="main-content position-relative border-radius-lg">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Data Obat</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Data Obat</h6>
                </nav>
        ...
        <div class="container-fluid py-4">
            <div class="mb-5">
                <a href="functions/tambahobat.php" class="p-3 rounded-2 bg-gradient-success text-bold">Tambah Data Obat</a>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6 class="text-2xl text-bold">Tabel Obat</h6>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                ...
                                if (isset($_GET['tambah'])) : ?>
                                    <script>
                                        Swal.fire("Data Obat Berhasil Ditambahkan");
                                    </script>
                                <?php endif; ?>
                                ...
                                if (isset($_GET['ubah'])) : ?>
                                    <script>
                                        Swal.fire("Data Obat Berhasil Diupdate");
                                    </script>
                                <?php endif; ?>
                                ...
                                if (isset($_GET['hapus'])) : ?>
                                    <script>
                                        Swal.fire("Data Obat Berhasil Dihapus");
                                    </script>
                                <?php endif; ?>
                                <!-- akhir alert -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php while ($apt = $hasil->fetch_assoc()) : ?>
                                            <tr>
                                                ...
                                                <td class="text-md mb-0"><?= $apt['nama_obat'] ?></td>
                                                <td class="align-middle text-center text-sm"><?= $apt['jenis'] ?></td>
                                                <td class="align-middle text-center text-sm">Rp. <?= $apt['harga'] ?></td>
                                                <td class="align-middle text-center text-sm"><?= $apt['stok'] ?></td>
                                                <td class="align-middle text-center text-sm"><?= $apt['nama_supplier'] ?></td>
                                                <td class="align-middle">
                                                    <a href="functions/editobat.php?id=<?= $apt['id_obat'] ?>"><i class="material-icons">edit</i></a>
                                                    <a href="functions/hapusobat.php?id=<?= $apt['id_obat'] ?>"><i class="material-icons" onclick=" return confirm ('Apakah Anda Yakin Ingin Menghapus data Ini ?');">delete</i></a>
                                                </td>
                                            </tr>
                                            <?php $i++ ?>
                                        <?php endwhile; ?>
